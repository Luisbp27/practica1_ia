...
from entorn import ClauPercepcio, AccionsRana, Direccio
...
class Laberint(joc.Joc):
    ...
    def __init__(
        self, agents: list[Rana], parets=False, mida_taulell: tuple[int, int] = (8, 8)
    ):
    ...
    def percepcio(self) -> entorn.Percepcio:
        ...
        return entorn.Percepcio(percep_dict)
